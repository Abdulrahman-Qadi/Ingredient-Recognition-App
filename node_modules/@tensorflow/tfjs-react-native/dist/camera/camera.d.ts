 ...
 * @doc {heading: 'Media', subheading: 'Camera'}
 */
export declare function fromTexture(gl: WebGL2RenderingContext, texture: WebGLTexture, sourceDims: Dimensions, targetShape: Dimensions, useCustomShadersToResize?: boolean, options?: FromTextureOptions): tf.Tensor3D;
/**
 ...
 * @doc {heading: 'Media', subheading: 'Camera'}
 */
export declare function renderToGLView(gl: WebGL2RenderingContext, texture: WebGLTexture, size: Size, flipHorizontal?: boolean, rotation?: Rotation): void;
export {};
