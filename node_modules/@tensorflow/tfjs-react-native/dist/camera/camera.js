 ...
 * @doc {heading: 'Media', subheading: 'Camera'}
 */
export function fromTexture(gl, texture, sourceDims, targetShape, useCustomShadersToResize = false, options = {}) {
    ...
    tf.util.assert([0, 90, 180, 270, 360, -90, -180, -270].includes(rotation), () => 'fromTexture Error: rotation must be ' +
        '0, +/- 90, +/- 180, +/- 270 or 360');
    const resizedTexture = runResizeProgram(gl, texture, sourceDims, targetShape, alignCorners, useCustomShadersToResize, interpolation, rotation);
 ...
 * @doc {heading: 'Media', subheading: 'Camera'}
 */
export function renderToGLView(gl, texture, size, flipHorizontal = true, rotation = 0) {
    tf.util.assert([0, 90, 180, 270, 360, -90, -180, -270].includes(rotation), () => 'renderToGLView Error: rotation must be ' +
        '0, +/- 90, +/- 180, +/- 270 or 360');
    size = {
